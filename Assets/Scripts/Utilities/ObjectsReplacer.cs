...
public class ObjectsReplacer //: EditorWindow
{
    ...
    //Toolbar action
    [MenuItem("PersonalUtilities/Objects Replacer")]
    
    public static void ShowWindow()
    {
        GetWindow<ObjectsReplacer>("Prefab Replacer");
    }
    ...
    private void ReplacePrefab()
    {
        ...
        for(int i = 0; i < selectedObjects.Length; i++)
        {
            ...
            {
                newObject = (GameObject)ObjectsReplacer.Instantiate(_replacementPrefab, oldParent);
